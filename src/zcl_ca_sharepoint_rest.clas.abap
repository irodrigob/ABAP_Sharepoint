CLASS zcl_ca_sharepoint_rest DEFINITION
  ...
  PUBLIC SECTION.
    TYPES: BEGIN OF ts_receive_get_folders_values,
             exists              TYPE string,
    ...
    TYPES: BEGIN OF ts_receive_get_files_values,
    ...
    TYPES: tt_receive_get_files_values TYPE STANDARD TABLE OF ts_receive_get_files_values WITH EMPTY KEY.
    TYPES: BEGIN OF ts_receive_get_user_info,
             id                           TYPE int4,
...
*             is_email_authentication_guest_user TYPE sap_bool,
    ...
    TYPES: BEGIN OF ts_get_user_folder_role,
             id   TYPE int4,
             name TYPE string,
           END OF ts_get_user_folder_role.
    TYPES: tt_get_user_folder_role TYPE STANDARD TABLE OF ts_get_user_folder_role WITH EMPTY KEY.
    TYPES: BEGIN OF ts_get_user_folder,
             user_id        TYPE int4,
             user_loginname TYPE string,
             role           TYPE tt_get_user_folder_role,
           END OF ts_get_user_folder.
    TYPES: tt_get_user_folder TYPE STANDARD TABLE OF ts_get_user_folder WITH EMPTY KEY.
    TYPES: BEGIN OF ts_recieve_sitegroup_id,
             id          TYPE int4,
             login_name  TYPE string,
             title       TYPE string,
    ...
    TYPES: tt_recieve_sitegroup_id TYPE STANDARD TABLE OF ts_recieve_sitegroup_id WITH EMPTY KEY.
    TYPES: BEGIN OF ts_get_user_folder_member,
             id                  TYPE int4,
             login_name          TYPE string,
             title               TYPE string,
    ...
    CONSTANTS: BEGIN OF cs_id_roles,
    ...
    METHODS generate_digest_value
      RETURNING VALUE(rv_digest_value) TYPE string
      RAISING   zcx_ca_http_services.
    METHODS create_folder
      IMPORTING iv_name                   TYPE any
                iv_break_role_inheritance TYPE sap_bool DEFAULT abap_true
      EXPORTING ev_folder_created         TYPE sap_bool
      RAISING   zcx_ca_http_services.
    METHODS add_file
      IMPORTING iv_path_folder  TYPE any
                iv_content_file TYPE xstring
                iv_file_name    TYPE string
      EXPORTING ev_file_upload  TYPE sap_bool
      RAISING   zcx_ca_http_services.
    METHODS get_folders
      IMPORTING
                iv_path_folder TYPE any OPTIONAL
      EXPORTING et_folders     TYPE tt_receive_get_folders_values
      RAISING   zcx_ca_http_services.
    METHODS get_files
      IMPORTING
                iv_path_folder TYPE any OPTIONAL
      EXPORTING et_files       TYPE tt_receive_get_files_values
      RAISING   zcx_ca_http_services.
    METHODS delete_file
      IMPORTING iv_path_folder   TYPE any OPTIONAL
                iv_file_name     TYPE string
                iv_verify_delete TYPE sap_bool DEFAULT abap_false
      EXPORTING ev_file_deleted  TYPE sap_bool
      RAISING   zcx_ca_http_services.
    METHODS delete_folder
      IMPORTING iv_path_folder    TYPE any OPTIONAL
                iv_folder_name    TYPE any
                iv_verify_delete  TYPE sap_bool DEFAULT abap_false
      EXPORTING ev_folder_deleted TYPE sap_bool
      RAISING   zcx_ca_http_services.
    METHODS break_role_inheritance
      IMPORTING iv_path_folder TYPE any
      RAISING   zcx_ca_http_services.
    METHODS get_user_info
      IMPORTING iv_user_cloud   TYPE string OPTIONAL
                iv_user_windows TYPE string OPTIONAL
                iv_user_saml    TYPE string OPTIONAL
                iv_user_id      TYPE int4 OPTIONAL
      EXPORTING es_user_info    TYPE ts_receive_get_user_info
      RAISING   zcx_ca_http_services.
    METHODS add_user_folder
      ...
      EXPORTING ev_role_added   TYPE sap_bool
      RAISING   zcx_ca_http_services.
    METHODS add_group_folder
      IMPORTING iv_group       TYPE string OPTIONAL
    ...
    METHODS remove_user_folder
      IMPORTING iv_user_cloud   TYPE string OPTIONAL
                ...
                iv_path_folder  TYPE string
      EXPORTING ev_role_removed TYPE sap_bool
      RAISING   zcx_ca_http_services.
    METHODS get_user_folder
      IMPORTING iv_path_folder   TYPE string
                iv_get_role      TYPE sap_bool DEFAULT abap_true
                iv_get_loginname TYPE sap_bool DEFAULT abap_true
      EXPORTING et_users         TYPE tt_get_user_folder
      RAISING   zcx_ca_http_services.
    METHODS get_user_folder_role
      IMPORTING iv_path_folder TYPE string
                iv_user_id     TYPE int4
      EXPORTING et_roles       TYPE tt_get_user_folder_role
      RAISING   zcx_ca_http_services.
    METHODS get_user_folder_member
      IMPORTING iv_path_folder TYPE string
                iv_user_id     TYPE int4
      EXPORTING es_member      TYPE ts_get_user_folder_member
      RAISING   zcx_ca_http_services.
    METHODS get_site_groups
      EXPORTING et_groups TYPE tt_recieve_sitegroup_id
      RAISING   zcx_ca_http_services.
    METHODS get_site_groups_by_name
      IMPORTING iv_name  TYPE string
      EXPORTING es_group TYPE ts_recieve_sitegroup_id
      RAISING   zcx_ca_http_services.
  ...
  PROTECTED SECTION.
    TYPES: BEGIN OF ts_receive_digest_value,
    ...
    TYPES: BEGIN OF ts_send_create_folder,
             BEGIN OF metadata,
               type TYPE string,
             END OF metadata,
             _server_relative_url TYPE string,
           END OF ts_send_create_folder.
    TYPES: BEGIN OF ts_receive_create_folder,
             exists            TYPE string,
             is_wopi_enabled   TYPE string,
             itemcount         TYPE i,
             name              TYPE string,
    ...
    TYPES: BEGIN OF ts_receive_add_file,
             check_in_comment       TYPE string,
             check_out_type         TYPE i,
             content_tag            TYPE string,
             customized_page_status TYPE i,
    ...
    TYPES: BEGIN OF ts_receive_get_folders,
             value TYPE tt_receive_get_folders_values,
           END OF ts_receive_get_folders.
    TYPES: BEGIN OF ts_receive_get_files,
             value TYPE tt_receive_get_files_values,
           END OF ts_receive_get_files.
    TYPES: BEGIN OF ts_receive_get_user_folder_id,
             principal_id TYPE int4,
           END OF ts_receive_get_user_folder_id.
    TYPES: tt_receive_get_user_folder_id TYPE STANDARD TABLE OF ts_receive_get_user_folder_id WITH EMPTY KEY.
    TYPES: BEGIN OF ts_receive_get_user_folder,
             value TYPE tt_receive_get_user_folder_id,
           END OF ts_receive_get_user_folder.
    TYPES: BEGIN OF ts_recieve_sitegroup,
             value TYPE tt_recieve_sitegroup_id,
           END OF ts_recieve_sitegroup.
    TYPES: BEGIN OF ts_receive_get_usrfold_role,
...
*    set_header_value( iv_name  = 'Content-Type' iv_value = 'application/json;odata=verbose' ).
    ...
    set_request_uri( |/sites/{ mv_site }/_api/web/GetFolderByServerRelativeUrl('{ lv_path }')/ListItemAllFields/breakroleinheritance(true)| ).
