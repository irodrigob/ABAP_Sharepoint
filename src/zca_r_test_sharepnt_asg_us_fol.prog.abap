*&---------------------------------------------------------------------*
*& Report ZCA_R_TEST_SHAREPNT_ASG_ROL_FO
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT zca_r_test_sharepnt_asg_us_fol.
...
START-OF-SELECTION.
  ...
  TRY.
      ...
      mo_sharepoint->add_user_folder(
        ...
        IMPORTING
          ev_role_added = DATA(lv_role_added) ).

      IF lv_role_added = abap_true.
        WRITE:/ 'Role added'.
      ELSE.
        WRITE:/ 'Error to assign role'.
      ENDIF.
